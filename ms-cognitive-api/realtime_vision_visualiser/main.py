...
class AnalyzerView:
    ...
    def __init__(self, master):
        ...
        vision_key = StringVar()
        self.entry_vision_key = Entry(frame, textvariable=vision_key)
        self.entry_vision_key.grid(row=1, column=1)
        vision_key.set('9b503f17139d4c89a98eabde1377b355')
        ...
        emotion_key.set('df7f34fe20094d87836b165c6adbce41')
